...
using PluginBigQuery.API.Read;
using PluginBigQuery.API.Replication;
using PluginBigQuery.API.Write;
using PluginBigQuery.DataContracts;
using PluginBigQuery.Helper;

namespace PluginBigQuery.Plugin
{
    public class Plugin : Publisher.PublisherBase
    {
        ...
        public override async Task<ConnectResponse> Connect(ConnectRequest request, ServerCallContext context)
        {
            ...
            try
            {
                _clientFactory.Initialize(_server.Settings);
            }
            catch (Exception e)
            {
                Logger.Error(e, e.Message, context);
            ...
            ServerCallContext context)
        {
            ...
            if (request.Mode == DiscoverSchemasRequest.Types.Mode.All)
            {
                ...
                try
                {
                    var schemas = Discover.GetAllSchemas(_clientFactory, sampleSize);
